...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_SHP_ETH_V2");

// Developed and tested at blockNumber 25135500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Morpho Vault V2 Steakhouse Prime WETH", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xbf4C718EAEf89bA7ba330a256533d381EeD09Fe3",
