...
const Strategy = artifacts.require("AuraV3StrategyMainnet_RZR_wstETH");

//This test was developed at blockNumber 23188741

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Aura RZR-wstETH", function() {
  let accounts;
  ...
  let rzr = "0xb4444468e444f89e1c2CAc2F1D3ee7e336cBD1f5";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xF2d8ad2984aA8050dD1CA1e74b862b165f7a622A");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"balancerV3": [rzr, wsteth]},
        {"balancerV3": [wsteth, rzr]},
        {"balancer": [aura, weth, wsteth]},
        {"balancer": [bal, weth, wsteth]},
