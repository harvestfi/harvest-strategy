...
const Strategy = artifacts.require("VerseStrategyMainnet_VERSE_ETH");
const IFeeRewardForwarder = artifacts.require("IFeeRewardForwarderV6");

//This test was developed at blockNumber 17230250

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Verse VERSE-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x94B3e5E5368bc559236623938B6E91Eb6753939A";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x845C0179060362f071FF5C7f1D2703617a480F3e");
