...
const Strategy = artifacts.require("VerseStrategyMainnet_USDC_ETH");
...
describe("Mainnet Verse USDC-ETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6E1fbeeABA87BAe1100d95f8340dc27aD7C8427b");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"sushi": [verse, weth, usdc]}, {"sushi": [verse, weth]}],
    });
